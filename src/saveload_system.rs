...
pub fn save_game(ecs : &mut World) {
    ...
    // Actually serialize
    {
        ...
        serialize_individually!(ecs, serializer, data, Position, Renderable, Player, SerializationHelper
        );
    }
...
pub fn load_game(ecs: &mut World) {
...

    {
        ...
        deserialize_individually!(ecs, de, d, Position, Renderable, Player,  SerializationHelper
        );
    }
