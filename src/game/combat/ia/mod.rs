...
use self::{components::{CheckGoal, Frozen}, plan_systems::{npc_ai_plan_forfeit, planning_adjacent_enemy, planning_can_do_melee_attack, planning_can_do_ranged_attack, planning_can_move, planning_enemy_in_sight, planning_evaluate_goals, planning_has_allies_nearby, planning_has_low_life}};
...
impl Plugin for IaPlugin {
    fn build(&self, app: &mut App) {
        ...
        .add_systems(Update,
            ...
            planning_can_move,
            npc_ai_plan_forfeit // DEBUG pour le moment.
